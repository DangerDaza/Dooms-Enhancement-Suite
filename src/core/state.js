...
export let extensionSettings = {
    settingsVersion: 24, // Version number for settings migrations
    enabled: true,
    autoUpdate: false,
    ...
    autoPortraitMode: 'off', // 'off', 'only_missing', 'state_changed', or 'every_reply'
    autoPortraitPromptSource: 'main_reply_tag', // 'main_reply_tag', 'separate_hidden_call', or 'tracker_fields_only'
    generatedPortraits: {}, // Metadata for portraits generated by DES Auto Portraits
    customAutoPortraitPrompt: '', // Custom Auto Portrait prompt text (empty = use default)
    syncExpressionsToPresentCharacters: false, // Legacy compatibility alias for Auto Portraits being enabled
