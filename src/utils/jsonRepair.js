 ...
 * @param {string} type - Type of tracker ('quests', 'infoBox', 'characters')
...
export function validateJSONSchema(data, type) {
    ...
    try {
        switch (type) {
            case 'quests':
                return data.main !== undefined || Array.isArray(data.optional);
            case 'infoBox':
 ...
 * @param {string} expectedType - Expected tracker type for validation ('quests', 'infoBox', 'characters')
