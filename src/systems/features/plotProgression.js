...
export async function sendPlotProgression(type) {
    ...
    try {
        ...
        // NOTE: Deception System and CYOA injections were here — archived to src/archived-features.js
        ...
        console.error('[Dooms Tracker] Error sending plot progression:', error);
